...
def complete_handler(ctx: ShellContext, *args):
    ...
    parser.add_argument("-r", dest="deregister_completer")
    ...
    elif parsed_args.deregister_completer is not None:
        if parsed_args.deregister_completer in ctx.completers:
            del ctx.completers[parsed_args.deregister_completer]
...
def history_handler(ctx: ShellContext, *args):
    ...
    parser.add_argument("-a", dest="append_to_history_file")
